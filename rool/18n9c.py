    ...
    for iteration in range(n):
        try:
            for i in range(len(inp_i)):
                ...
                weights_ = [weight_1_2, weight_2_3, weight_3_4, weight_4_5, weight_5_6, weight_6_7, weight_7_8, weight_8_9, weight_9_10,
...
# print(a_bd[0])
# print(bd[0])
print(ney4(bd, a_bd, 20000000, ves18n9c_4, alpha=0.0000000000000000001))
