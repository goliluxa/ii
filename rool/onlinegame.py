...
def ney4(inp_i, goal_pred_i, n, vesa=list(), alpha=0.00003):
    ...
    if len(vesa) != 0:
        ...
        weight_1_2 = np.random.randn(2, 2)
        weight_2_3 = np.random.randn(2, 2)
        weight_3_4 = np.random.randn(2, 2)
        weight_4_5 = np.random.randn(2, 1)
    # print(weight_)
...
for i in range(0, len(s) // 2 * 2):
    if s[i - 2][0] - s[i - 4][0] == 1 and s[i][0] - s[i - 2][0] == 2:
        a = False
        # print(i, i - 1)
...
# print(a_bd[0])
# print(bd[0])
print(ney4(bd, a_bd, 10000, ves0_2, 0.00001))

# [array([[ 1.60288341, -0.50521856],
#        [ 0.29156523, -1.03131956]]), array([[-0.93463865,  0.41974284],
#        [ 1.5119945 , -0.62232969]]), array([[-0.8809141 , -0.82738071],
#        [-0.63719998, -0.14999948]]), array([[ 2.38152213],
#        [-1.61932579]])]
